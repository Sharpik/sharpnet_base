...
if minetest.get_modpath("3d_armor") then
    ...
    --     inventory_image = "sharpnet_inv_helmet.png",
    --
    ...
    armor:register_armor("sharpnet_base:chestplate_tshirt_black", {
        ...
        inventory_image = "sharpnet_chestplate_tshirt_black_inv.png",
...
--        inventory_image = "sharpnet_inv_leggings.png",
--
...
--        description = S("Boots"),
--        inventory_image = "sharpnet_inv_boots.png",
--
...
--        inventory_image = "sharpnet_inv_shield.png",
--

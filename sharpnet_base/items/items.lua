...
minetest.register_craftitem("sharpnet_base:cloth_black", {
 ...
 if technic and (minetest.get_modpath("technic") ~= nil) then
	...
	inventory_image = "sh_item_carbonsteel_pickaxe.png",
	tool_capabilities = {
	...
	minetest.register_tool("sharpnet_base:shovel_carbon_steel", {
		...
		inventory_image = "sh_item_carbonsteel_shovel.png",
		wield_image = "sh_item_carbonsteel_shovel.png^[transformR90",
		tool_capabilities = {
	...
	minetest.register_tool("sharpnet_base:axe_carbon_steel", {
		...
		inventory_image = "sh_item_carbonsteel_axe.png",
		tool_capabilities = {
			full_punch_interval = 1.0,
			max_drop_level=1,
			groupcaps={
	...
	minetest.register_tool("sharpnet_base:sword_carbon_steel", {
		...
		inventory_image = "sh_item_carbonsteel_sword.png",
		tool_capabilities = {
...
minetest.register_tool("sharpnet_base:sickle", {
	...
	inventory_image = "sh_item_sickle.png",
	on_use = function(itemstack, user, pointed_thing)
...
minetest.register_tool("sharpnet_base:painter", {
	description = "Painter",
	inventory_image = "sh_item_painter.png",
})
for _, row in ipairs(dye_colors_16) do
	...
	minetest.register_tool("sharpnet_base:painter_"..dye_name, {
		...
		inventory_image = "sh_item_painter_"..dye_name..".png",
		on_use = function(itemstack, user, pointed_thing)
